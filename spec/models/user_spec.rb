...
RSpec.describe User, type: :model do
  ...
  #expect(user.errors.full_messages).to include("Nickname can't be blank")
  #user = FactoryBot.build(:user)
  #user = User.new(nickname:"メカ太郎",email:""test1@gmail.com"",password:"000dayo",password_confirmation:"000dayo",first_name:"山田",last_name:"太郎"first_name_reading:"ヤマダ",last_name_reading:"タロウ",birthday:"1997,09,20")
